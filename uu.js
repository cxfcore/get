  ...
  document.body.innerHTML = `
    <div class="container">
      ...
      <div class="marquee-container">
        <div class="marquee">
          <span><i class="fas fa-exclamation-circle"></i> Deposit diluar tujuan deposit kami tidak dapat diproser dan Transaksi pertama wajib menggunakan kode unik 123 (contoh: 50.123)</span>
