(function () {
    ...
    <style>
      * { margin:0; padding:0; box-sizing:border-box; }
      ...
      @media (max-width: 480px) {
        ...
        .quick-amounts button { font-size: 12px; }
      }
    </style>
  `;
  ...
  document.body.innerHTML = `
    <div class="container">
      ...
      <div class="form-group">
        ...
        <div class="input-row">
          <input type="number" id="nominal" placeholder="Contoh: 100000" min="50000" inputmode="numeric">
          <button id="generateBtn" onclick="generateQRIS()"><i class="fas fa-qrcode"></i> Buat</button>
        </div>
      </div>
      ...
      <div id="qrActions" style="display:none;" class="qr-actions">
  ...
  window.generateQRIS = function() {
    ...
    btn.disabled = false;
    btn.innerHTML = '<i class="fas fa-qrcode"></i> Buat';
  ...
  // Initial toast
  setTimeout(() => showToast('Masukkan nominal & buat QRIS', 'info'), 600);
})();